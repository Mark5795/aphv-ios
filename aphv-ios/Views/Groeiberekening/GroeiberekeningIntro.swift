        ...
        ZStack {
            ...
            VStack {
                ...
                if(localStorage.isLoggedIn) {
                    ...
                    NavigationLink(destination: GroeiberekeningExtraStap(groeiberekeningViewModel: groeiberekeningViewModel, isFlowStarted: $isFlowStarted)) {
                        Text("Start Groeiberekening")
                            .font(.system(size: 20))
                            .fontWeight(.medium)
                            .foregroundColor(Color.white)
...
struct GroeiberekeningIntro_Preview: PreviewProvider {
    static var previews: some View {
        GroeiberekeningIntro(isFlowStarted: .constant(true))
    }
}
